...
/*
* Note: This code appears to be pretty much unchanged from the Nordic supplied code. I haven't tried to go through it and 
* comment it or clean it up. 
*/
...
static bool is_battery_init = false;
